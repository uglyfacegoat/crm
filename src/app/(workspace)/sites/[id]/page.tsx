...
const healthPresentation: Record<WebsiteHealthStatus, { label: string; tone: string; icon: typeof CircleCheck }> = {
  healthy: { label: "Сайт работает штатно", tone: "#b8f7e4", icon: CircleCheck },
