...
export default async function MastersPage() {
  ...
  return <div><PageHeading eyebrow="Исполнители" title="Мастера" description="Зоны работы, контакты и текущая загрузка специалистов." action={canWrite ? <CreateMasterButton /> : undefined} /><MastersWorkspace masters={masters} canWrite={canWrite} /></div>;
}
