  ...
  return (
    <article className="surface-panel min-w-0 p-[clamp(0.9rem,0.75rem+0.32vw,1.2rem)]">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0"><p className="truncate text-[10px] font-medium text-[var(--muted)]">{label}</p><p className="mt-3 font-display text-[clamp(1.25rem,1rem+0.5vw,1.75rem)] font-semibold tracking-[-0.045em] text-[var(--text)]">{value}</p></div>
