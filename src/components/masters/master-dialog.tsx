...
function MasterAvailabilityFields({ state, master }: { state: MasterMutationState; master?: MasterListItem }) {
  ...
  return <section className="overflow-hidden border border-white/[0.09] bg-[#0b1013]">
