...
const statusStyle: Record<MasterStatusCode, string> = {
  scheduled: "border-[#91e9ce]/20 bg-[#91e9ce]/10 text-[#b8f7e4]",
  available: "border-[#b8f7e4]/20 bg-[#b8f7e4]/10 text-[#b8f7e4]",
  overloaded: "border-[#f07832]/20 bg-[#f07832]/10 text-[#f2945d]",
  vacation: "border-[#b8f7e4]/20 bg-[#b8f7e4]/10 text-[#b8f7e4]",
