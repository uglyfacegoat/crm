...
const eventAccent: Record<VisitEventType, string> = {
  ...
  schedule_changed: "border-[#b8f7e4]/25 bg-[#b8f7e4]/[0.07] text-[#b8f7e4]",
  status_changed: "border-[#b8f7e4]/25 bg-[#b8f7e4]/[0.08] text-[#b8f7e4]",
