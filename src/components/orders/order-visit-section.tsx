...
const visitStatusStyles: Record<ServiceVisit["statusCode"], string> = {
  ...
  confirmed: "bg-[#91e9ce]/10 text-[#75d8ce]",
  in_progress: "bg-[#b8f7e4]/12 text-[#b8f7e4]",
  completed: "bg-[#b8f7e4]/10 text-[#74d9ac]",
