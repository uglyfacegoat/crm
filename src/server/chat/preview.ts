...
export function getPreviewChatWorkspace(member: AuthenticatedMember): ChatWorkspaceData {
  ...
  return {
    channels: [{ id: channelId, name: "Общий чат", description: "Главный рабочий канал офиса", kind: "general", memberCount: 3, unreadCount: 0, lastMessage: "Рабочий режим подключит настоящую историю.", lastMessageAt: "2026-08-29T09:30:00.000Z", lastAuthor: "Система", version: 1 }],
    activeChannel: { id: channelId, name: "Общий чат", description: "Главный рабочий канал офиса", kind: "general", memberCount: 3, unreadCount: 0, lastMessage: "Рабочий режим подключит настоящую историю.", lastMessageAt: "2026-08-29T09:30:00.000Z", lastAuthor: "Система", version: 1 },
