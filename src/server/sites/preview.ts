...
export function getPreviewWebsiteSnapshot(): WebsiteSnapshot {
  ...
  return {
    ...
    trafficTrend: { labels: ["04 авг", "09 авг", "14 авг", "19 авг", "24 авг", "29 авг", "02 сен"], series: [
      { label: "Посетители", color: "#b8f7e4", values: [3210, 3880, 3560, 4210, 4890, 5560, 5910] },
      { label: "Просмотры", color: "#9ca5a3", values: [6820, 7310, 7010, 8420, 9630, 10820, 11240] },
      { label: "Поисковые клики", color: "#f4f7f6", values: [710, 840, 790, 980, 1120, 1270, 1390] },
    ] },
    trafficSources: [
