...
const visualCases = [
  ...
  { name: "settings-appearance-mobile", path: "/settings", width: 320, height: 568, openSettingsTab: "Представление" },
  { name: "settings-backups-desktop", path: "/settings", width: 1920, height: 1080, openSettingsTab: "Резервные копии" },
  { name: "settings-backups-mobile", path: "/settings", width: 320, height: 568, openSettingsTab: "Резервные копии" },
